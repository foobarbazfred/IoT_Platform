...
# Sensor Client
#
# micro controller : Raspberry Pi Pico 2 W 
...
# you can install by mip　on REPL
# import mip
...
MQTT_BROKER = "<set the server's host name or IP>"  # ThingsBoard Server running on Raspberry Pi
MQTT_PORT = 1883
